...
# Define classes
corndiseases_classes = ["Corn Common Rust", "Corn Gray Leaf Spot", "Corn Healthy", "Corn Northern Leaf Blight", "Not Corn Leaf"]
...
if uploaded_file is not None:
    ...
    img_array = np.array(test_image) / 255.0  # Normalize image
...
st.markdown("5. Not Corn Leaf menunjukkan bahwa gambar yang diunggah bukan daun jagung atau tidak dapat dikenali sebagai salah satu dari 4 kategori sebelumnya.")
